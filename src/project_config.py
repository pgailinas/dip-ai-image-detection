...
CROSS_VALIDATION_TUNED_RESULTS_FILENAME = "cross_validation_tuned_results.csv"
...
CROSS_VALIDATION_TUNED_RESULTS_PATH = f"{RESULTS_METADATA_DIR}/{CROSS_VALIDATION_TUNED_RESULTS_FILENAME}"
