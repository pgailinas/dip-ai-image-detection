...
---
## Outputs
- `train_feature_vectors.csv` — combined feature vectors for train dataset (N samples × 25 features)
- `test_feature_vectors.csv` — combined feature vectors for test dataset (N smaples x 25 features)
---
