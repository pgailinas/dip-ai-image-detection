...
The final evaluation, presented in the *Results & Insights*, shows that the approach achieves strong classification performance on a balanced, multi-source dataset, indicating that the feature-based representation captures meaningful and generalizable differences between real and synthetic images.
