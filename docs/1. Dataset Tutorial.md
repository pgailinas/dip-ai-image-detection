...
This project stores large image datasets externally using Google Drive.

### Step 1: Download Image Archives

Download the following ZIP files from Google Drive:

- Raw datasets (6 sources)
- Preprocessed datasets (6 sources)
...
⚠️ Do not create additional nested folders during extraction.

## Dataset Setup (earlier content)
