...
The results also highlight the complementary nature of the three feature domains. Gradient-domain features primarily capture edge structure and directional behavior, spatial-domain features emphasize texture consistency and entropy characteristics, while frequency-domain features capture spectral energy distributions and frequency irregularities. The improved performance of the full model demonstrates that these domains contribute distinct but complementary statistical information.
