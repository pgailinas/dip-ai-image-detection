...
The ROC curves further reinforce these observations. Stronger-performing source pairs rise rapidly toward the upper-left region of the plot, indicating excellent separability, while lower-performing combinations exhibit smoother and more gradual ROC trajectories that reflect increased overlap between real and synthetic feature distributions.

The relatively consistent separation across all ROC curves suggests that the handcrafted DIP feature representation captures generalized statistical image characteristics rather than overfitting to a single dataset or generator source. Although classification difficulty varies across source combinations, the results demonstrate that robust generator-independent AI-image detection remains feasible when integrating gradient-domain, spatial-domain, and frequency-domain information within a unified feature representation.
