...
Although the RBF SVM achieved the strongest overall ROC-AUC after tuning, the MLP remained highly effective within the DIP feature space and was selected for subsequent feature-level and source-pair analyses because of its ability to model distributed nonlinear feature interactions across multiple statistical image domains.
